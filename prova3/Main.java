        ...
        while(flag){
            ...
            switch (op){
                ...
                case 2:
                    ...
                    ArrayList <Aluno> estud = arq.ler();
                    Collections.sort(estud);
                    Collections.reverse(estud);

                    for (int i = 0; i < estud.size(); i++) {
                        System.out.println(" - ");
                        System.out.println("Dados dos Alunos");
                        System.out.println(estud.get(i).getNome());
                        System.out.println(estud.get(i).getMedia());
                        System.out.println(estud.get(i).getCurso());
                        System.out.println(estud.get(i).getMatricula());
                        System.out.println(" - ");
                        if(estud.get(i).getCurso().equals("Computação")){
                            contComp++;
                        }
                        else if(estud.get(i).getCurso().equals("Software")){
                            contSoftware++;
                        }
                        else if(estud.get(i).getCurso().equals("Telecomunicações")){
                            contTelecom++;
                        }
                    }
                    break;
